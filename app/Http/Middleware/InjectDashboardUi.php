...
class InjectDashboardUi
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (str_contains($html, 'id="notifMenu"')) {
            ...
            $roleAccessAsset = asset('js/role-access-layout.js') . '?v=20260816-8';
