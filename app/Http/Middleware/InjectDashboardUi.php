...
class InjectDashboardUi
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (str_contains($html, 'id="notifMenu"')) {
            $adminPreviewFix = '<style id="siberad-admin-preview-fix">.lp-layout{grid-template-columns:minmax(0,1.15fr) minmax(0,1fr) !important;width:100%;min-width:0;}.lp-panel,.lp-preview-panel{min-width:0;max-width:100%;box-sizing:border-box;}.lp-preview-panel{overflow:hidden;}.lp-preview-body{min-width:0;overflow:hidden;}.lp-browser-frame{width:100%;max-width:100%;min-width:0;box-sizing:border-box;}.lp-preview{width:100%;max-width:100%;min-width:0;overflow:hidden;}.lp-features{grid-template-columns:repeat(2,minmax(0,1fr));}.lp-feature-card,.lp-p,.lp-h1,.lp-h2,.lp-eyebrow{min-width:0;overflow-wrap:anywhere;word-break:break-word;}@media(max-width:1100px){.lp-layout{grid-template-columns:minmax(0,1fr) !important;}.lp-preview-panel{position:relative;top:auto;}}</style>';
