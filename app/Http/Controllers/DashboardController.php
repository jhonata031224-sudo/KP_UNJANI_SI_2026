...
class DashboardController
{
    ...
    private function admin(Request $request, $user, $satuan): View
    {
        ...
        $labelKategori = [Satuan::KATEGORI_SATLAK => 'Satlak', Satuan::KATEGORI_DIREKTORAT => 'Direktorat', Satuan::KATEGORI_PIMPINAN => 'Pimpinan', Satuan::KATEGORI_ADMIN => 'Admin', Satuan::KATEGORI_POKPEL => 'Pok Pel', Satuan::KATEGORI_KOTAMA => 'Kasansi'];
