(function () {
  ...
  function installStyles() {
    if (document.getElementById('role-access-layout-style-v5')) return;
    var style = document.createElement('style');
    style.id = 'role-access-layout-style-v5';
    style.textContent = [
      ...
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(1),[data-tab-panel="role-akses"] .role-access-table td:nth-child(1){width:25%;padding-left:34px;padding-right:16px}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(2),[data-tab-panel="role-akses"] .role-access-table td:nth-child(2){width:26%;padding-left:16px;padding-right:16px}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(3),[data-tab-panel="role-akses"] .role-access-table td:nth-child(3){width:49%;padding-left:16px;padding-right:20px}',
      ...
      '[data-tab-panel="role-akses"] .role-access-access-layout{display:grid;grid-template-columns:minmax(0,1fr) 196px;align-items:start;column-gap:18px;width:100%;min-width:0}',
      ...
      '[data-tab-panel="role-akses"] .role-access-save{width:100%;max-width:none;min-width:0;box-sizing:border-box;text-align:center;justify-content:center;line-height:1.35;white-space:normal;word-break:normal;align-self:start}',
      '@media(max-width:900px){[data-tab-panel="role-akses"] .role-access-table th,[data-tab-panel="role-akses"] .role-access-table td{padding:12px 10px}[data-tab-panel="role-akses"] .role-access-table th:nth-child(1),[data-tab-panel="role-akses"] .role-access-table td:nth-child(1){width:28%;padding-left:24px}[data-tab-panel="role-akses"] .role-access-table th:nth-child(2),[data-tab-panel="role-akses"] .role-access-table td:nth-child(2){width:28%}[data-tab-panel="role-akses"] .role-access-table th:nth-child(3),[data-tab-panel="role-akses"] .role-access-table td:nth-child(3){width:44%}[data-tab-panel="role-akses"] .role-access-access-layout{grid-template-columns:minmax(0,1fr) 180px;column-gap:12px}}',
      '@media(max-width:700px){[data-tab-panel="role-akses"] .role-access-table{table-layout:auto}[data-tab-panel="role-akses"] .role-access-table thead{display:none}[data-tab-panel="role-akses"] .role-access-table,[data-tab-panel="role-akses"] .role-access-table tbody,[data-tab-panel="role-akses"] .role-access-table tr,[data-tab-panel="role-akses"] .role-access-table td{display:block;width:100%!important}[data-tab-panel="role-akses"] .role-access-table tbody tr{padding:14px 0;border-bottom:1px solid var(--border-soft)}[data-tab-panel="role-akses"] .role-access-table tbody tr:last-child{border-bottom:0}[data-tab-panel="role-akses"] .role-access-table td{border:0!important;padding:7px 12px;background:transparent!important}[data-tab-panel="role-akses"] .role-access-table td:first-child{padding-left:24px;padding-right:12px}[data-tab-panel="role-akses"] .role-access-access-layout{display:flex;flex-direction:column;gap:12px}[data-tab-panel="role-akses"] .role-access-permissions{width:100%;max-width:none}[data-tab-panel="role-akses"] .role-access-save{width:100%;max-width:none;min-width:0}}'
    ].join('');
  ...
  function normalizeExistingTable(section) {
    ...
    if (headers.length >= 4) {
      ...
      if (roleIdx >= 0 && descIdx >= 0 && permIdx >= 0 && actionIdx >= 0) {
        table.querySelectorAll('tbody tr').forEach(function (tr, rowIndex) {
          ...
          if (form) {
            normalizeForm(form, button, form.id || ('role-access-form-legacy-' + rowIndex));
    ...
    table.querySelectorAll('tbody tr').forEach(function (row) {
      ...
      normalizeForm(form, row.querySelector('button[type="submit"]'));
    });
    return true;
  }
