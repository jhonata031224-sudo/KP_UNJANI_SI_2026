(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(1),[data-tab-panel="role-akses"] .role-access-table td:nth-child(1){width:24%;padding-left:22px;padding-right:12px}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(2),[data-tab-panel="role-akses"] .role-access-table td:nth-child(2){width:25%;padding-left:12px;padding-right:12px}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(3),[data-tab-panel="role-akses"] .role-access-table td:nth-child(3){width:34%;padding-left:12px;padding-right:10px}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(4),[data-tab-panel="role-akses"] .role-access-table td:nth-child(4){width:17%;padding-left:8px;padding-right:12px}',
      ...
      '[data-tab-panel="role-akses"] .role-access-save{white-space:nowrap}',
      '[data-tab-panel="role-akses"] .role-access-action{text-align:left!important;vertical-align:middle!important}',
