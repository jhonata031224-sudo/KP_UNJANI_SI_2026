(function () {
  ...
  function installStyles() {
    if (document.getElementById('role-access-layout-style-v12')) return;
    var oldStyle = document.getElementById('role-access-layout-style-v11');
    if (oldStyle) oldStyle.remove();
    var style = document.createElement('style');
    style.id = 'role-access-layout-style-v12';
    style.textContent = [
      ...
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(1),[data-tab-panel="role-akses"] .role-access-table td:nth-child(1){width:16%!important}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(2),[data-tab-panel="role-akses"] .role-access-table td:nth-child(2){width:24%!important}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(3),[data-tab-panel="role-akses"] .role-access-table td:nth-child(3){width:42%!important}',
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(4),[data-tab-panel="role-akses"] .role-access-table td:nth-child(4){width:18%!important}',
      ...
      '[data-tab-panel="role-akses"] .role-access-table th:nth-child(3),[data-tab-panel="role-akses"] .role-access-table td:nth-child(3){padding-left:24px}',
      ...
      '[data-tab-panel="role-akses"] .role-access-desc{margin:0;color:var(--text-muted);font-size:12px;line-height:1.6;overflow-wrap:break-word;word-break:normal}',
      ...
      '[data-tab-panel="role-akses"] .role-access-permissions{display:flex;flex-direction:column;align-items:stretch;gap:8px;margin:0;min-width:0;width:100%;max-width:100%}',
      '[data-tab-panel="role-akses"] .role-access-permission{display:flex;align-items:flex-start;gap:10px;width:100%;box-sizing:border-box;min-width:0;padding:9px 12px;border:1px solid var(--border-soft);border-radius:8px;background:var(--panel-alt);color:var(--text-muted);font-size:11.5px;line-height:1.4;cursor:pointer;white-space:normal;transition:border-color .15s,background .15s}',
      '[data-tab-panel="role-akses"] .role-access-permission:hover{border-color:var(--border-strong)}',
      '[data-tab-panel="role-akses"] .role-access-permission:has(input:checked){border-color:var(--gold-bright);background:var(--gold-dim)}',
      '[data-tab-panel="role-akses"] .role-access-permission input{margin:2px 0 0;flex:0 0 auto;accent-color:var(--gold-bright)}',
      '[data-tab-panel="role-akses"] .role-access-permission .perm-card-main{flex:1 1 auto;min-width:0;width:auto}',
      '[data-tab-panel="role-akses"] .role-access-permission .perm-card-title{overflow-wrap:break-word;word-break:normal}',
      '[data-tab-panel="role-akses"] .role-access-permission .perm-card-desc{overflow-wrap:break-word;word-break:normal}',
      '[data-tab-panel="role-akses"] .role-access-permission .perm-card-status{flex:0 0 auto}',
