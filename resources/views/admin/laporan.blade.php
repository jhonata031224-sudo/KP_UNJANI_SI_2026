...
<title>Laporan Pengguna & Aktivitas — {{ $pengaturan?->namaSistem() ?? 'SIBERAD' }}</title>
<style>
  ...
  .btn.primary{background:#FF9800;color:#1a1206;border-color:#FF9800;font-weight:600;}
...
<body>
  ...
  <p class="sub">{{ $pengaturan->nama_instansi }} — {{ $pengaturan?->namaSistem() ?? 'SIBERAD' }}</p>
