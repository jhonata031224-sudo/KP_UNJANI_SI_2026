...
(function(){
  ...
  // Rahasia: kolom "Isi Ringkasan Surat" disembunyikan & dibikin opsional --
  // isinya toh nggak bakal ditampilkan ke penerima (lihat
  // LaporanSurat::ringkasanUntuk()), jadi nggak perlu dipaksa diisi juga.
  ...
  function syncDeskripsiUntukRahasia(){
    ...
    if(rahasia){
      ...
      deskripsiInput.classList.remove('field-invalid');
    } else {
