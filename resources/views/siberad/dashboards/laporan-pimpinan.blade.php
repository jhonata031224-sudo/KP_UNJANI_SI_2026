...
.sidebar.collapsed .side-nav-group.open .side-subnav>div{max-height:calc(min(420px,calc(100vh - 80px)) - 16px);overflow-y:auto;overflow-x:hidden;gap:8px;}
...
.sidebar.collapsed .side-nav-group.open .side-sub-link.active:before{left:6px;top:50%;transform:translateY(-50%);width:6px;height:6px;border-radius:2px;background:var(--p-accent);}
...
@media(max-width:900px){
  ...
  .sidebar.collapsed .side-subnav>div{margin-left:18px;border-left:1px solid var(--p-border,var(--border-soft));padding:3px 0;display:flex;flex-direction:column;gap:8px}
