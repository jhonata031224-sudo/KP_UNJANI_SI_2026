...
(function(){
  ...
  function makeStatusChart(id){const el=document.getElementById(id);if(!el||typeof Chart==='undefined')return;window.siberadCharts.push(new Chart(el,{type:'doughnut',data:{labels:['Disetujui','Ditolak','Terlambat','Dibatalkan'],datasets:[{data:[statusData.disetujui,statusData.ditolak,statusData.terlambat,statusData.dibatalkan],backgroundColor:['#22c55e','#ef4444','#ff6b6b','#c1121f'],borderColor:'transparent',borderWidth:2}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{position:'bottom'}}}}))}
