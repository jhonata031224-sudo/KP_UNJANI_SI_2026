...
@media(max-width:900px){
  ...
  .sidebar.collapsed .side-subnav>div{margin-left:18px;border-left:2px solid var(--p-border,var(--border-soft));padding:4px 0;display:flex;flex-direction:column;gap:6px}
