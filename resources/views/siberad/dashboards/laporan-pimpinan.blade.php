...
<section id="surat-masuk" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Surat Masuk</h2><p>Surat yang ditujukan kepada {{ $satuan->nama }}. Murni informasi -- tidak ada status/progres yang perlu ditindaklanjuti.</p></div></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Dari</th><th>Perihal</th><th>Prioritas</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody>@forelse($suratMasuk as $s)@include('siberad.dashboards.partials.surat-masuk-row', ['s' => $s])@empty<tr><td colspan="5"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--p-muted)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada surat masuk</div><div class="empty-state-sub">Surat yang ditujukan ke {{ $satuan->nama }} akan muncul di sini.</div></div></td></tr>@endforelse</tbody></table></div></div></section>
