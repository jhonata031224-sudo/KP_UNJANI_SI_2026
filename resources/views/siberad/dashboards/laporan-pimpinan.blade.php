...
<style>
:root{--p-bg:#f5f7f9;--p-surface:#fff;--p-surface-2:#f8fafc;--p-border:#e2e8f0;--p-text:#17212b;--p-muted:#64748b;--p-accent:#FF9800;--p-green:#16834b;--p-red:#c83b3b;--p-yellow:#b77900;--p-shadow:0 10px 30px rgba(15,23,42,.07)}
