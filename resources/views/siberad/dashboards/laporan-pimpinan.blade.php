...
.request-task-list{padding:10px 18px 14px 34px;background:var(--p-surface-2);display:flex;flex-direction:column;gap:7px}
.request-task-item{display:flex;align-items:center;gap:8px;font-size:12px;color:var(--p-text)}
.request-task-item.done{color:var(--p-green)}
.task-check-icon{flex-shrink:0;font-size:13px;width:16px;text-align:center}
.request-task-item .request-muted{margin-left:auto;font-size:10.5px}
