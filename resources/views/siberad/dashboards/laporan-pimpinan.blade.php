...
.request-task-step.active::before{background:#334155;box-shadow:0 4px 12px -4px rgba(51,65,85,.5)}
.request-task-step.active .request-task-num{background:#fff;color:#334155}
...
.request-task-step.clickable:focus-visible{outline:2px solid #334155;outline-offset:2px}
