...
(function(){
  ...
  document.getElementById('batalkanPermintaanOverlay')?.addEventListener('click',e=>{if(e.target.id==='batalkanPermintaanOverlay')tutupBatalkanPermintaan()});
  ...
  document.getElementById('editDeadlinePermintaanModal')?.addEventListener('click',e=>{if(e.target.id==='editDeadlinePermintaanModal')tutupEditDeadlinePermintaan()});
