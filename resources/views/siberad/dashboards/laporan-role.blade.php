...
{{-- ===== MONITORING: SATLAK KAL (PENANGKALAN) ===== --}}
<section id="monitoring-kal" class="tab-panel">
  <div class="section-head panel">
    <h2>Satlak Kal &mdash; Penangkalan</h2>
    <p>Pantau aktivitas laporan dari Satuan Pelaksana Penangkalan (Satlak Kal).</p>
  </div>
  <div class="monitor-grid">
    <div class="monitor-card">
      <div class="name">Satlak Kal (Penangkalan)</div>
      <div class="num">{{ $totalKal }}</div>
      <div class="sub">Laporan dalam sistem</div>
    </div>
  </div>
  <div class="panel" style="margin-top:16px">
    <div class="tbl-wrap">
      <table class="dtbl">
        <thead><tr><th>Satlak</th><th>Perihal</th><th>Prioritas</th><th>Status</th><th>Tanggal</th><th>Aksi</th></tr></thead>
        <tbody>
          @forelse($laporanKal as $l)
            @include('siberad.dashboards.partials.monitor-satlak-row', ['l' => $l])
          @empty
            <tr><td colspan="6"><div class="empty-state">
              ...
              <div class="empty-state-title">Belum ada laporan dari Satlak Kal.</div>
              <div class="empty-state-sub">Aktivitas Penangkalan akan muncul di sini.</div>
            </div></td></tr>
          @endforelse
        </tbody>
      </table>
...
{{-- ===== MONITORING: SATLAK DAK (PENINDAKAN) ===== --}}
<section id="monitoring-dak" class="tab-panel">
  <div class="section-head panel">
    <h2>Satlak Dak &mdash; Penindakan</h2>
    <p>Pantau aktivitas laporan dari Satuan Pelaksana Penindakan (Satlak Dak).</p>
  </div>
  <div class="monitor-grid">
    <div class="monitor-card">
      <div class="name">Satlak Dak (Penindakan)</div>
      <div class="num">{{ $totalDak }}</div>
      <div class="sub">Laporan dalam sistem</div>
    </div>
  </div>
  <div class="panel" style="margin-top:16px">
    <div class="tbl-wrap">
      <table class="dtbl">
        <thead><tr><th>Satlak</th><th>Perihal</th><th>Prioritas</th><th>Status</th><th>Tanggal</th><th>Aksi</th></tr></thead>
        <tbody>
          @forelse($laporanDak as $l)
            @include('siberad.dashboards.partials.monitor-satlak-row', ['l' => $l])
          @empty
            <tr><td colspan="6"><div class="empty-state">
              <svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg>
              <div class="empty-state-title">Belum ada laporan dari Satlak Dak.</div>
              <div class="empty-state-sub">Aktivitas Penindakan akan muncul di sini.</div>
            </div></td></tr>
          @endforelse
        </tbody>
      </table>
...
{{-- ===== MONITORING: SATLAK SIBER SOS (SIBER SOSIAL) ===== --}}
<section id="monitoring-sisos" class="tab-panel">
  <div class="section-head panel">
    <h2>Satlak Siber Sos &mdash; Siber Sosial</h2>
    <p>Pantau aktivitas laporan dari Satuan Pelaksana Siber Sosial (Satlak Siber Sos).</p>
  </div>
  <div class="monitor-grid">
    <div class="monitor-card">
      <div class="name">Satlak Siber Sos (Siber Sosial)</div>
      <div class="num">{{ $totalSisos }}</div>
      <div class="sub">Laporan dalam sistem</div>
    </div>
  </div>
  <div class="panel" style="margin-top:16px">
    <div class="tbl-wrap">
      <table class="dtbl">
        <thead><tr><th>Satlak</th><th>Perihal</th><th>Prioritas</th><th>Status</th><th>Tanggal</th><th>Aksi</th></tr></thead>
        <tbody>
          @forelse($laporanSisos as $l)
            @include('siberad.dashboards.partials.monitor-satlak-row', ['l' => $l])
          @empty
            <tr><td colspan="6"><div class="empty-state">
              <svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg>
              <div class="empty-state-title">Belum ada laporan dari Satlak Siber Sos.</div>
              <div class="empty-state-sub">Aktivitas Siber Sosial akan muncul di sini.</div>
            </div></td></tr>
          @endforelse
        </tbody>
      </table>
