...
<title>{{ $satuan->nama ?? 'Laporan' }} — {{ ($pengaturan->hero_judul_awal ?? '') . ($pengaturan->hero_judul_aksen ?? 'SIBERAD') }}</title>
...
<div class="confirm-overlay" id="konfirmasiSuratOverlay"><div class="confirm-box" role="alertdialog" aria-modal="true" aria-labelledby="konfirmasiSuratTitle"><div class="confirm-icon" style="background:rgba(34,197,94,.12);color:#16a34a"><svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="none" stroke-width="1.9"><path d="M20 6 9 17l-5-5"></path></svg></div><h3 id="konfirmasiSuratTitle">Konfirmasi Surat?</h3><p id="konfirmasiSuratBody">Konfirmasi surat ini? Pengirim akan mengetahui bahwa surat sudah diterima.</p><div class="confirm-actions"><button type="button" class="btn" id="konfirmasiSuratBatal">Batal</button><button type="button" class="btn btn-primary" id="konfirmasiSuratYa">Ya, Konfirmasi</button></div></div></div>
...
<section id="dashboard" class="tab-panel active"><div class="dash-hero"><div><div class="dash-hero-eyebrow">SIBERAD // {{ $satuan->kode }}</div><h2>{{ $satuan->nama }}</h2><p>{{ now()->translatedFormat('l, d F Y') }}</p></div></div><div class="report-grid"><div class="stat-card"><div class="lbl">Disetujui</div><div class="val" style="color:#22c55e;">{{ $stats['disetujui'] }}</div><div class="sub">Laporan diterima</div></div><div class="stat-card"><div class="lbl">Ditolak</div><div class="val" style="color:#ef4444;">{{ $stats['ditolak'] }}</div><div class="sub">Laporan ditolak</div></div><div class="stat-card"><div class="lbl">Terlambat</div><div class="val" style="color:#ff6b6b;">{{ $stats['terlambat'] }}</div><div class="sub">Permintaan lewat tenggat</div></div><div class="stat-card"><div class="lbl">Dibatalkan</div><div class="val" style="color:#c1121f;">{{ $stats['dibatalkan'] }}</div><div class="sub">Permintaan yang dibatalkan</div></div></div><div class="report-layout"><div class="report-card"><h3>Statistik Laporan</h3><p>Distribusi status laporan yang tersimpan di sistem.</p><div style="height:260px;margin-top:12px"><canvas id="laporanChart"></canvas></div><div class="chart-legend" id="laporanChartLegend"></div></div></div></section>
...
@if($isKasansi)<section id="kirim-laporan-kendala" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Kirim Kendala</h2><p>Sampaikan kendala {{ $satuan->nama }} langsung kepada Danpus, lalu pantau status tindak lanjutnya di sini.</p></div><button type="button" class="detail-btn kirim-laporan-btn" id="kirimKendalaOpen" style="white-space:nowrap">Kirim Kendala</button></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Perihal</th><th style="text-align:center">Tujuan</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Tembusan &amp; Balasan</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody>@forelse($kendalaTerkirim as $k)@include('siberad.dashboards.partials.kendala-terkirim-row', ['k' => $k])@empty<tr><td colspan="7"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada laporan kendala</div><div class="empty-state-sub">Kendala yang kamu kirim ke Danpus akan muncul di sini.</div></div></td></tr>@endforelse</tbody></table></div></div></section>@endif
@if($isKasansi)<section id="arsip-kendala-kasansi" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Arsip Kendala</h2><p>Laporan kendala {{ $satuan->nama }} yang sudah dikonfirmasi selesai ditindaklanjuti oleh Danpus.</p></div></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Perihal</th><th style="text-align:center">Tujuan</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Tembusan &amp; Balasan</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody>@forelse($kendalaArsip as $k)@include('siberad.dashboards.partials.kendala-terkirim-row', ['k' => $k])@empty<tr><td colspan="7"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada kendala yang diarsipkan</div><div class="empty-state-sub">Kendala yang sudah dikonfirmasi Danpus akan otomatis pindah ke sini.</div></div></td></tr>@endforelse</tbody></table></div></div></section>@endif
@if($bisaKirimSurat)<section id="kirim-surat" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Buat Surat</h2><p>Surat yang sudah dikirim dan <strong>belum dikonfirmasi</strong> oleh penerima. Setelah dikonfirmasi, surat otomatis pindah ke Arsip Surat.</p></div><button type="button" class="detail-btn kirim-laporan-btn" id="kirimSuratOpen" style="white-space:nowrap">Buat Surat</button></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Perihal</th><th style="text-align:center">Tujuan</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody id="suratTerkirimBody">@forelse($suratTerkirim as $s)@include('siberad.dashboards.partials.surat-terkirim-row', ['s' => $s])@empty<tr><td colspan="6"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Tidak ada surat yang menunggu konfirmasi</div><div class="empty-state-sub">Semua surat yang terkirim sudah dikonfirmasi penerima dan masuk ke Arsip Surat.</div></div></td></tr>@endforelse</tbody></table></div></div></section>@endif
@if($bisaKirimSurat)<section id="arsip-surat" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Arsip Surat</h2><p>Riwayat surat yang sudah <strong>dikonfirmasi</strong> penerima. Surat yang belum dikonfirmasi masih ada di tabel Kirim Surat.</p></div></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Perihal</th><th style="text-align:center">Tujuan</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody id="suratArsipBody">@forelse($suratArsip as $s)@include('siberad.dashboards.partials.surat-arsip-row', ['s' => $s])@empty<tr><td colspan="6"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada surat yang diarsipkan</div><div class="empty-state-sub">Surat masuk ke arsip setelah dikonfirmasi oleh penerima.</div></div></td></tr>@endforelse</tbody></table></div></div></section>@endif
<section id="surat-masuk" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Surat Masuk</h2><p>Surat yang ditujukan kepada {{ $satuan->nama }}. Klik <strong>Konfirmasi</strong> untuk memberi tanda bahwa surat sudah diterima -- pengirim akan mengetahuinya.</p></div></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Dari</th><th>Perihal</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody id="suratMasukBody">@forelse($suratMasuk as $s)@include('siberad.dashboards.partials.surat-masuk-row', ['s' => $s])@empty<tr><td colspan="6"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada surat masuk</div><div class="empty-state-sub">Surat yang ditujukan ke {{ $satuan->nama }} akan muncul di sini.</div></div></td></tr>@endforelse</tbody></table></div></div></section>
@if($isPenerimaTembusan)<section id="laporan-tembusan" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Laporan Tembusan</h2><p>Info koordinasi dari Kasansi (Sansidam) yang menembuskan laporan kendalanya ke {{ $satuan->nama }}. Ini bukan laporan yang perlu Anda putuskan -- keputusan tetap ada di Danpus.</p></div></div><div class="tbl-wrap"><table class="dtbl"><thead><tr><th>Perihal</th><th style="text-align:center">Dari</th><th>Prioritas</th><th style="text-align:center">Status</th><th style="text-align:center">Balasan</th><th style="text-align:center">Tanggal</th><th style="text-align:center">Aksi</th></tr></thead><tbody>@forelse($tembusanMasuk as $t)@include('siberad.dashboards.partials.laporan-kendala-tembusan-row', ['t' => $t])@empty<tr><td colspan="7"><div class="empty-state"><svg viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="var(--text-dim)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="12" height="17" rx="2"></rect><path d="M9 4h6"></path><path d="M9 10h6"></path><path d="M9 14h6"></path><path d="M9 18h3"></path></svg><div class="empty-state-title">Belum ada laporan tembusan</div><div class="empty-state-sub">Tembusan dari Kasansi akan muncul di sini.</div></div></td></tr>@endforelse</tbody></table></div></div></section>@endif
