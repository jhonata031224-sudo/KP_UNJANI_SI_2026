...
@if($isKasansi)<section id="kirim-laporan-kendala" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Kirim Kendala</h2><p>Sampaikan kendala {{ $satuan->nama }} langsung kepada Danpus, lalu pantau status tindak lanjutnya di sini.</p></div><button type="button" class="detail-btn kirim-laporan-btn" id="kirimKendalaOpen" style="white-space:nowrap">+ Kirim Kendala</button></div><div class="kcard-grid" id="kcard-grid-terkirim">@forelse($kendalaTerkirim as $k)@include('siberad.dashboards.partials.kendala-terkirim-row', ['k' => $k])@empty<div class="kcard-empty"><svg viewBox="0 0 24 24" width="38" height="38" fill="none" stroke="var(--text-dim)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg><div class="kcard-empty-title">Belum ada laporan kendala</div><div class="kcard-empty-sub">Kendala yang kamu kirim ke Danpus akan muncul di sini.</div></div>@endforelse</div></div></section>@endif
@if($isKasansi)<section id="arsip-kendala-kasansi" class="tab-panel"><div class="panel"><div class="panel-head"><div><h2>Arsip Kendala</h2><p>Laporan kendala {{ $satuan->nama }} yang sudah dikonfirmasi selesai ditindaklanjuti oleh Danpus.</p></div></div><div class="kcard-grid" id="kcard-grid-arsip-kasansi">@forelse($kendalaArsip as $k)@include('siberad.dashboards.partials.kendala-terkirim-row', ['k' => $k])@empty<div class="kcard-empty"><svg viewBox="0 0 24 24" width="38" height="38" fill="none" stroke="var(--text-dim)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8v13H3V8"/><path d="M23 3H1v5h22V3z"/><path d="M10 12h4"/></svg><div class="kcard-empty-title">Belum ada kendala yang diarsipkan</div><div class="kcard-empty-sub">Kendala yang sudah dikonfirmasi Danpus akan otomatis pindah ke sini.</div></div>@endforelse</div></div></section>@endif
