...
@media(max-width:980px){.report-grid{grid-template-columns:1fr 1fr}.pimp-kpis{grid-template-columns:repeat(2,1fr)}.report-layout{grid-template-columns:1fr}.monitor-grid{grid-template-columns:1fr 1fr}.satuan-terbaru-row{grid-template-columns:1fr}}@media(max-width:650px){.report-grid,.pimp-kpis,.form-grid,.monitor-grid,.detail-grid{grid-template-columns:1fr}.form-field.full,.detail-item.full{grid-column:auto}.monitor-kpi-row{gap:16px 22px}.monitor-toolbar select{flex:1 1 140px}}
