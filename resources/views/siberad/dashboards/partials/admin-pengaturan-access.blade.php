...
.admin-access-icon{width:58px;height:58px;border-radius:15px;background:#fff3dc;color:#EEA23A;display:flex;align-items:center;justify-content:center;margin-bottom:16px}
...
.admin-access-input:focus{border-color:#EEA23A;box-shadow:0 0 0 3px rgba(201,122,0,.12);background:#fff}
...
.admin-access-refresh:hover{border-color:#EEA23A;color:#EEA23A;background:#fffaf1}
...
.admin-access-btn.submit{border:1px solid #EEA23A;background:#EEA23A;color:#111827;min-width:176px;box-shadow:0 5px 14px rgba(201,122,0,.18)}
