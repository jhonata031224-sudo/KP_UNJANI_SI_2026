...
.admin-access-card{width:440px;max-width:calc(100vw - 36px);box-sizing:border-box;background:#fff;color:#17212b;border:1px solid #e2e8f0;border-radius:18px;box-shadow:0 28px 72px rgba(0,0,0,.32);padding:24px 24px 22px;position:relative;transform:translateY(10px) scale(.985);transition:transform .2s ease}
