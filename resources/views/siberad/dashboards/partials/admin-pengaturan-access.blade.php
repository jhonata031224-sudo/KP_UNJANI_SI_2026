...
.admin-access-captcha-row{display:grid;grid-template-columns:minmax(0,1.15fr) 54px minmax(0,1fr);gap:10px;align-items:center}
...
.admin-access-captcha-input{min-width:0;padding-left:14px;padding-right:14px}
...
<div class="admin-access-field"><label class="admin-access-label" for="adminAccessPassword">Password</label><div class="admin-access-input-wrap"><input id="adminAccessPassword" class="admin-access-input" type="password" autocomplete="current-password" placeholder="Masukkan password"><button type="button" class="admin-access-password-toggle" id="adminAccessToggle" aria-label="Tampilkan password"><svg viewBox="0 0 24 24"><path d="M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Z"/><circle cx="12" cy="12" r="2.5"/></svg></button></div></div>
