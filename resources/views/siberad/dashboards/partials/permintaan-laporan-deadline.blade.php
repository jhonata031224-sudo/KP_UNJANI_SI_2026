...
.deadline-task-list{display:flex;flex-direction:column;gap:6px;margin:8px 0;align-items:flex-end}
.deadline-task-item{display:flex;align-items:center;gap:7px;font-size:11px;cursor:pointer;color:var(--p-text,var(--text))}
.deadline-task-item.done{color:var(--green,#16834b);text-decoration:line-through;text-decoration-color:color-mix(in srgb,currentColor 50%,transparent)}
.deadline-task-item input{cursor:pointer}
</style>
