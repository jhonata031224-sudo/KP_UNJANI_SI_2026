...
.deadline-task-step{position:relative;display:flex;align-items:center;gap:6px;border:0;cursor:pointer;padding:7px 20px 7px 18px;margin-right:-11px;font:inherit;font-size:10.5px;font-weight:700;white-space:nowrap;background:var(--p-surface-2,var(--panel-alt));color:var(--p-muted,var(--text-muted));clip-path:polygon(0 0,calc(100% - 13px) 0,100% 50%,calc(100% - 13px) 100%,0 100%,13px 50%);transition:background .15s ease,color .15s ease,filter .15s ease}
.deadline-task-step:first-child{clip-path:polygon(0 0,calc(100% - 13px) 0,100% 50%,calc(100% - 13px) 100%,0 100%);padding-left:14px}
.deadline-task-step:last-child{margin-right:0;clip-path:polygon(0 0,100% 0,100% 100%,0 100%,13px 50%);padding-right:14px}
