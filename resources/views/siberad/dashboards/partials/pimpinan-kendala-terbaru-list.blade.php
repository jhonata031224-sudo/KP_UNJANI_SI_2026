{{-- Isi kartu "Kendala Kasansi Terbaru" -- dipakai render awal &
     ...
     padahal harusnya merah). Baris data SENGAJA tanpa icon di kiri (dulu
     ada .pimp-activity-ico, dihapus biar baris lebih ringkas -- status-pill
     di kanan udah cukup jadi penanda visual; empty state di bawah TETAP
     pakai icon besar di tengah, beda konteks). Empty state pakai class kcard-empty yang
