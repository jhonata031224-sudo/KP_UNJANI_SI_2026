...
/* Komponen select bergaya kayak dropdown sort di Log Aktivitas Pimpinan —
   ...
   hardcode #EEA23A/#b56d00 -- persis nilai yang dipakai dropdown sort Log
...
.styled-select-trigger:hover,.styled-select-wrap.open .styled-select-trigger{border-color:#EEA23A;background:var(--p-surface,var(--panel));box-shadow:0 3px 12px rgba(15,23,42,.06)}
.styled-select-trigger:focus-visible{outline:none;border-color:#EEA23A;box-shadow:0 0 0 3px rgba(201,122,0,.10)}
...
.styled-select-menu-inner::-webkit-scrollbar-thumb:hover{background:#EEA23A;background-clip:padding-box}
