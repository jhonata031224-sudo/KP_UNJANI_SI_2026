...
/* Komponen select bergaya kayak dropdown sort di Log Aktivitas Pimpinan —
   ...
   hardcode #EEB341/#b56d00 -- persis nilai yang dipakai dropdown sort Log
...
.styled-select-trigger:hover,.styled-select-wrap.open .styled-select-trigger{border-color:#EEB341;background:var(--p-surface,var(--panel));box-shadow:0 3px 12px rgba(15,23,42,.06)}
.styled-select-trigger:focus-visible{outline:none;border-color:#EEB341;box-shadow:0 0 0 3px rgba(201,122,0,.10)}
...
.styled-select-menu-inner::-webkit-scrollbar-thumb:hover{background:#EEB341;background-clip:padding-box}
