...
.monitor-toolbar .styled-select-wrap{width:auto;min-width:150px;max-width:190px;flex:0 0 auto}
...
@media(max-width:650px){.monitor-toolbar .styled-select-wrap{flex:1 1 calc(50% - 5px);min-width:0;max-width:none}}
</style>
<script>
(function(){
